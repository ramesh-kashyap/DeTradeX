        ...
        try{
           ...
           $data['level'] = $user->level+1;
            ...
            Auth::loginUsingId($registered_user_id);
             addNotification($registered_user_id, 'Welcome to DCXPRO', 'Start exploring, earn rewards, and connect with others. We’re here if you need help. Let’s grow together.Our team is here for help if you need any assistance.Thank you for joining us, and we look forward to your success!');
         addNotification(
            $user->id,
            'Referral Joined',
            "Dear Member, thank you for inviting your friend {$data['name']}! They've successfully joined the DCXPRO team. Keep guiding them — let’s grow together!");
