...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Your OTP from DCXPRO</title>
  </head>
  <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px;">
    <div style="max-width: 500px; margin: auto; background-color: #ffffff; padding: 20px 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
      ...
      <br />
      <p style="font-size: 16px; color: #555;">Thanks for choosing <strong>DCXPRO</strong>.</p>
      <p style="font-size: 16px; color: #888;">– DCXPRO Team</p>
    </div>
  </body>
</html>
